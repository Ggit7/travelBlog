...
export default function ViewTravelStory({storyInfo,onClose,onDeleteClick,onEditClick}) {

    const Id = localStorage.getItem('userId')
    const Id1=storyInfo.userId._id 
  return (
    <div className='relative'>
      <div className='flex items-center justify-end'>
        ...
        <div className='flex item-center gap-3 bg-cyan-50/50 p-2 rounded-l-lg'>
                ...
                <button className='btn-small bg-red-300 text-white hover:bg-red-600' onClick={onDeleteClick}>
